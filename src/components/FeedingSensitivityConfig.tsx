      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-6">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Configure como o sistema deve ajustar automaticamente as quantidades de ração baseado no comportamento de consumo observado.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="excess_leftover">Sobrou Bastante</Label>
                <Input
                  id="excess_leftover"
                  type="number"
                  step="0.1"
                  ...
                  className="w-full"
                />
                <p className="text-xs text-muted-foreground">Reduzir quando sobrar bastante ração</p>
              </div>

              <div className="space-y-2">
                <Label htmlFor="no_consumption">Não Comeu</Label>
                <Input
                  id="no_consumption"
                  type="number"
                  step="0.1"
          ...
          <div className="space-y-4">
            <h4 className="font-semibold text-sm">Configurações de Suspensão</h4>
            <p className="text-sm text-muted-foreground">
              Configurações para suspender automaticamente a alimentação quando os animais não consumirem por várias alimentações consecutivas (apenas para avaliação "Não Comeu").
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Número de avaliações consecutivas "Não Comeu" antes de suspender alimentação
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="w-full"
                />
                <p className="text-xs text-muted-foreground">Tempo de suspensão antes de retomar alimentação normal</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h4 className="font-semibold text-sm">Análise de Tendências</h4>
            <p className="text-sm text-muted-foreground">
              Configuração para análise geral de tendências de consumo na fazenda.
            </p>
            ...
            <div className="space-y-2 max-w-md">
              ...
              />
              <p className="text-xs text-muted-foreground">
                Número de alimentações anteriores a considerar para cálculo de tendências de consumo
              </p>
            </div>
          </div>
        </div>
