...
export default function Auth() {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-auth-bg-primary via-auth-bg-primary/90 to-auth-bg-primary/70 flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-lg relative backdrop-blur-sm bg-card/95 shadow-[var(--shadow-ocean)]">
        <CardHeader className="text-center space-y-4">
          ...
          <div>
            ...
            <CardDescription className="text-muted-foreground">Sistema de gestão para Fazendas de Camarão</CardDescription>
          </div>
        </CardHeader>
            ...
            <TabsContent value="signin" className="space-y-4">
              <form onSubmit={handleSignIn} className="space-y-4">
                ...
                <div className="text-right">
                  <Button type="button" variant="link" size="sm" className="p-0 h-auto text-primary hover:text-primary-hover" onClick={() => setForgotPasswordOpen(true)}>
                    Esqueci minha senha
                  </Button>
                </div>

                <Button type="submit" className="w-full bg-gradient-to-r from-primary to-primary-hover hover:from-primary-hover hover:to-primary" disabled={isLoading}>
                  {isLoading ? <Waves className="w-4 h-4 animate-pulse" /> : 'Entrar'}
                </Button>
