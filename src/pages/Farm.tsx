...
import { Plus, Waves, Edit, Trash2, MapPin, Activity, CheckCircle } from 'lucide-react';
    ...
    return (
      <Layout>
        <div className="text-center py-12">
          <Shrimp className="w-16 h-16 text-muted-foreground mx-auto mb-4" />
